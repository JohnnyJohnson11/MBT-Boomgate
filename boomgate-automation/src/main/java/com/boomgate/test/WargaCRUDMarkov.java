...
@GraphWalker(value = "quick_random(edge_coverage(100))", start = "v_adminDashboard")
@Model(file = "com/boomgate/test/WargaCRUDMarkov.json")
public class WargaCRUDMarkov extends ExecutionContext {
    public WargaCRUDMarkov() {
    ...
    public void e_createWarga(){
        ...
        WebElement addFullName = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("addFullName")));
        ...
        verifyTable();
        assertEquals(true, verifyNewData(fullName), fullName);
    }
